...
const Offer: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      <div className="bg-[#4caf4f] text-white py-3 px-4 text-center">
        ...
        <div className="bg-[#d9d9d9] p-8 rounded-md h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-md flex flex-col items-center">
              <button className="bg-[#4caf4f] text-white py-3 px-6 rounded-md w-full mb-6 hover:bg-[#3d9c3f]">
              ...
              <div className="relative w-full">
                ...
                />
                <Plus
                  className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#4caf4f]"
                  size={20}
                />
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-md flex flex-col items-center">
              ...
              <div className="flex items-center w-full border border-gray-300 rounded-md overflow-hidden">
                <button className="px-4 py-2 text-[#4caf4f]">
                  <Minus size={20} />
                </button>
                <input
                  type="number"
